...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/trame-common-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/trame-common-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add trame-common
# for installing globally
pixi global install trame-common
```
...
It is possible to list all of the versions of `trame-common` available on your platform:
...
```
pixi search trame-common --channel conda-forge
```
